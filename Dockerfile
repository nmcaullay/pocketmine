...
RUN wget http://jenkins.pocketmine.net/job/PocketMine-MP-Bleeding/30/artifact/PocketMine-MP_1.6dev-30_mcpe-0.12_86c11986_API-1.13.0.phar
...
CMD ["./bin/php5/bin/php", "/pocketmine/PocketMine-MP_1.6dev-30_mcpe-0.12_86c11986_API-1.13.0.phar"]
